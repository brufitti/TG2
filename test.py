...
def addtolist(in_queue, shared_list):
...
def printlist(in_queue, shared_list):
...
def main():
    ...
    odd_result = pool.apply_async(addtolist, (odd_queue, shared_list))
    even_result = pool.apply_async(printlist, (even_queue, shared_list))
